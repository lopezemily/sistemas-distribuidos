package sd_aula09_smartdoor.view;

import java.rmi.RemoteException;
import java.util.logging.Level;
import java.util.logging.Logger;
import javax.swing.JOptionPane;
import sd_aula09_smartdoor.controller.SmartDoor_Controller;
...
public class SmartDoorJFrame extends javax.swing.JFrame {
    ...
    private final SmartDoor_Controller sdController;

    public SmartDoorJFrame() throws RemoteException {
        this.sdController = new SmartDoor_Controller(sd);
        initComponents();
    ...
    private void SenhajButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SenhajButtonActionPerformed
        try {
            ...
            Logger.getLogger(SmartDoorJFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
