...
public class LightJFrame extends javax.swing.JFrame {
    ...
    private void PowerjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PowerjButtonActionPerformed
        try {
            ...
            Logger.getLogger(LightJFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
